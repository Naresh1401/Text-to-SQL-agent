...
with st.sidebar:
    ...
    <div style="background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);border-radius:12px;padding:16px;margin-top:8px;">
        <div style="font-weight:700;font-size:1rem;color:#ccd6f6;margin-bottom:6px;">👨‍💻 Naresh</div>
        <div style="font-size:0.8rem;color:#8892b0;line-height:1.6;">
            GenAI Engineer · Full-Stack ML<br>
            <b style="color:#64ffda;">Skills:</b> LLMs · RAG · Fine-tuning · LangChain · FastAPI · Docker<br>
            <b style="color:#64ffda;">Stack:</b> Python · OpenAI · FAISS · Qdrant · Streamlit
        </div>
        <div style="margin-top:10px;font-size:0.75rem;">
            <a href="https://github.com/Naresh1401" style="color:#64ffda;text-decoration:none;">GitHub</a>
        </div>
        <details style="margin-top:10px;">
            <summary style="color:#8892b0;font-size:0.8rem;cursor:pointer;">🚀 More Projects</summary>
            <div style="font-size:0.75rem;color:#8892b0;margin-top:8px;line-height:1.8;">
